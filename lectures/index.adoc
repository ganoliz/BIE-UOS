...
The materials are being modified this year, so we will gradually add them here.
  ...
  . *Command-line parsing order, special characters, command execution, shell variables*
    ...
    * OnlineFit: link:https://online.fit.cvut.cz/zaznam/B231/bie-uos.21_pre_2023-10-03.html[part1], link:https://online.fit.cvut.cz/zaznam/B231/bie-uos.21_pre_2023-10-10.html[part2]
