...
The submission limit is *13.11.2022 at 23:00*. After that the solutions will be archived.

==== Assignment

On the server *`fray1`* in the directory *`tyden7`* ( directory createdin task 1), create a script that
