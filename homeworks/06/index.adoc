...
<li><details><summary>Determine the directory structure in directory <code>logs</code> with the command <code>find</code>. Calculate the rows of all files with the extension <code>log</code> in subdirectories.</summary>
++++
....
find
wc -l */*/*.log
